...
export const SingleImage = (props) => {
  ...
  return (
    <div className="imageBox" key={imageObj.id}>
      <div className="imageBoxTop">
        ...
        {imageObj.userId === props.userId && (
          <button
            ...
            type="button"
            onClick={() => props.destroyImage(props.userId, props.imageObj.id)}
          >
        ...
        <p>
          Uploaded {moment(imageObj.createdAt).fromNow()}{" "}
          {imageObj.userId === props.userId ? (
            <Link to="/my-images">
      ...
      <CommentList
        imageId={imageObj.id}
        comments={imageObj.comments}
        expanded={expandCollapse.expanded}
      />
      <div className="imageButtons">
        {expandCollapse.moreThanThree && (
          <button
            className="expandCommentsBut"
            onClick={() =>
              setExpandCollapse({
                ...expandCollapse,
                expanded: !expandCollapse.expanded,
            ...
            type="submit"
            style={{ backgroundColor: boxColor.expandComments }}
          >
            {expandCollapse.expanded ? (
        ...
        <button
          className="addCommentsBut"
          type="submit"
          onClick={() =>
            setExpandCommentSubmit({
              extended: !expandCommentSubmit.extended,
            })
          }
          style={{ backgroundColor: boxColor.expandSubmit }}
        >
          Post a comment
        </button>

        {expandCommentSubmit.extended && <AddComment imageId={imageObj.id} />}
      </div>
    </div>
  );
};
